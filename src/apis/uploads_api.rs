...
pub async fn create_upload(
...
) -> Result<ResponseContent<CreateUploadSuccess>, Error<CreateUploadError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateUploadSuccess> =
...
pub async fn get_upload_by_id(
    configuration: &configuration::Configuration,
    params: GetUploadByIdParams,
) -> Result<ResponseContent<GetUploadByIdSuccess>, Error<GetUploadByIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetUploadByIdSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetUploadByIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
