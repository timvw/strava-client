...
pub async fn get_activity_by_id(
...
) -> Result<ResponseContent<GetActivityByIdSuccess>, Error<GetActivityByIdError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = include_all_efforts {
        local_var_req_builder =
            local_var_req_builder.query(&[("include_all_efforts", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetActivityByIdSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetActivityByIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_comments_by_activity_id(
    configuration: &configuration::Configuration,
    params: GetCommentsByActivityIdParams,
) -> Result<ResponseContent<GetCommentsByActivityIdSuccess>, Error<GetCommentsByActivityIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCommentsByActivityIdSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetCommentsByActivityIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_kudoers_by_activity_id(
    configuration: &configuration::Configuration,
    params: GetKudoersByActivityIdParams,
) -> Result<ResponseContent<GetKudoersByActivityIdSuccess>, Error<GetKudoersByActivityIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetKudoersByActivityIdSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetKudoersByActivityIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_laps_by_activity_id(
    configuration: &configuration::Configuration,
    params: GetLapsByActivityIdParams,
) -> Result<ResponseContent<GetLapsByActivityIdSuccess>, Error<GetLapsByActivityIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetLapsByActivityIdSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetLapsByActivityIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_logged_in_athlete_activities(
    ...
    ResponseContent<GetLoggedInAthleteActivitiesSuccess>,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetLoggedInAthleteActivitiesSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetLoggedInAthleteActivitiesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_zones_by_activity_id(
    configuration: &configuration::Configuration,
    params: GetZonesByActivityIdParams,
) -> Result<ResponseContent<GetZonesByActivityIdSuccess>, Error<GetZonesByActivityIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetZonesByActivityIdSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetZonesByActivityIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_activity_by_id(
    configuration: &configuration::Configuration,
    params: UpdateActivityByIdParams,
) -> Result<ResponseContent<UpdateActivityByIdSuccess>, Error<UpdateActivityByIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateActivityByIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
