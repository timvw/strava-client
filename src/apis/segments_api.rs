...
pub async fn explore_segments(
    configuration: &configuration::Configuration,
    params: ExploreSegmentsParams,
) -> Result<ResponseContent<ExploreSegmentsSuccess>, Error<ExploreSegmentsError>> {
    ...
    if let Some(ref local_var_str) = min_cat {
        local_var_req_builder =
            local_var_req_builder.query(&[("min_cat", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = max_cat {
        local_var_req_builder =
            local_var_req_builder.query(&[("max_cat", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ExploreSegmentsSuccess> =
        ...
        let local_var_entity: Option<ExploreSegmentsError> =
            serde_json::from_str(&local_var_content).ok();
...
pub async fn get_logged_in_athlete_starred_segments(
    configuration: &configuration::Configuration,
    params: GetLoggedInAthleteStarredSegmentsParams,
) -> Result<
    ResponseContent<GetLoggedInAthleteStarredSegmentsSuccess>,
    Error<GetLoggedInAthleteStarredSegmentsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetLoggedInAthleteStarredSegmentsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetLoggedInAthleteStarredSegmentsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_segment_by_id(
...
) -> Result<ResponseContent<GetSegmentByIdSuccess>, Error<GetSegmentByIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetSegmentByIdSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetSegmentByIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn star_segment(
    configuration: &configuration::Configuration,
    params: StarSegmentParams,
) -> Result<ResponseContent<StarSegmentSuccess>, Error<StarSegmentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<StarSegmentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<StarSegmentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
