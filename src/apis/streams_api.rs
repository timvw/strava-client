...
pub async fn get_activity_streams(
...
) -> Result<ResponseContent<GetActivityStreamsSuccess>, Error<GetActivityStreamsError>> {
    ...
    local_var_req_builder =
        local_var_req_builder.query(&[("key_by_type", &key_by_type.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetActivityStreamsSuccess> =
        ...
        let local_var_entity: Option<GetActivityStreamsError> =
            serde_json::from_str(&local_var_content).ok();
...
pub async fn get_route_streams(
    configuration: &configuration::Configuration,
    params: GetRouteStreamsParams,
) -> Result<ResponseContent<GetRouteStreamsSuccess>, Error<GetRouteStreamsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetRouteStreamsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetRouteStreamsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_segment_effort_streams(
    configuration: &configuration::Configuration,
    params: GetSegmentEffortStreamsParams,
) -> Result<ResponseContent<GetSegmentEffortStreamsSuccess>, Error<GetSegmentEffortStreamsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetSegmentEffortStreamsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetSegmentEffortStreamsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_segment_streams(
    configuration: &configuration::Configuration,
    params: GetSegmentStreamsParams,
) -> Result<ResponseContent<GetSegmentStreamsSuccess>, Error<GetSegmentStreamsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetSegmentStreamsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetSegmentStreamsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
