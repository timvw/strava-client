...
pub async fn get_logged_in_athlete(
    configuration: &configuration::Configuration,
) -> Result<ResponseContent<GetLoggedInAthleteSuccess>, Error<GetLoggedInAthleteError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetLoggedInAthleteSuccess> =
        ...
        let local_var_entity: Option<GetLoggedInAthleteError> =
            serde_json::from_str(&local_var_content).ok();
...
pub async fn get_logged_in_athlete_zones(
    configuration: &configuration::Configuration,
) -> Result<ResponseContent<GetLoggedInAthleteZonesSuccess>, Error<GetLoggedInAthleteZonesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetLoggedInAthleteZonesSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetLoggedInAthleteZonesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_stats(
...
) -> Result<ResponseContent<GetStatsSuccess>, Error<GetStatsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetStatsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
