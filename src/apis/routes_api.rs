...
pub async fn get_route_as_gpx(
    configuration: &configuration::Configuration,
    params: GetRouteAsGpxParams,
) -> Result<ResponseContent<GetRouteAsGpxSuccess>, Error<GetRouteAsGpxError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetRouteAsGpxSuccess> =
        ...
        let local_var_entity: Option<GetRouteAsGpxError> =
            serde_json::from_str(&local_var_content).ok();
...
pub async fn get_route_as_tcx(
    configuration: &configuration::Configuration,
    params: GetRouteAsTcxParams,
) -> Result<ResponseContent<GetRouteAsTcxSuccess>, Error<GetRouteAsTcxError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetRouteAsTcxSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetRouteAsTcxError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_route_by_id(
...
) -> Result<ResponseContent<GetRouteByIdSuccess>, Error<GetRouteByIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetRouteByIdSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetRouteByIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
